...
class OfferAcceptOrDenyController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        ->select('table_customer.*','table_customer.id AS cus_id','cl_enquieries.*','cl_enquieries.id AS enq_id','statuses.*')
            ...
            // dd($offer_acceptance);
            return view('adminviews.OfferAcceptanceOrDeney',["offered_cus"=>$offer_acceptance]);
    }
    ...
    public function show($id)
    {
         ...
         return view('adminviews.viewPdf',["pdf"=>$customer_pdf->pdf_name]);
    }
