...
class offerAcceptedUploadFile extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($offer_accepted);
            return view('adminviews.offerAccepted',["accepted_cus"=>$offer_accepted,"status_code"=>$status_codes]);
    ...
    public function show($id)
    {
        ...
        ->first();
            // dd($doc_for_enquiery);
         return view('adminviews.OtherDocumentUpload',["user_info"=>$doc_for_enquiery]);
    ...
    public function edit($id)
    {
        ...
        {
            return view('adminviews.MandateryFilesUpload',["cus_id"=>$id,"man_doc_status"=>$user_man_docs->mandatory_doc_status]);
        }

        return view('adminviews.MandateryFilesUpload',["cus_id"=>$id,"man_doc_status"=>0]);
    }
