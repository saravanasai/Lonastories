...
Route::prefix('user')->middleware(['user'])->group(function () {
    ...
    Route::post('existingEmiShedule/delete', [CustomerDataStoreController::class, 'existingEmiSheduleDelete'])->name('user.existingEmiSheduleDelete');
...
Route::get('user/login/verifyLoginOtp', [CustomerController::class, 'loginVerify'])->name('userLoginVerify');
