        ...
        <div class="row">
            <div class="col-md-6 text pl-md-3 pr-md-5 pt-md-5 pt-sm-2 mt-lg-2 mt-sm-2">
                ...
                <div class="pt-md-5 pt-sm-5" data-aos="zoom-in" data-aos-duration="3000">
                    ...
                    @else
                    <a href="{{route('quickEnquieryForm.index')}}" class="col-md-5 col-sm-4 mt-md-0 mt-sm-5 btn btn-outline-secondary pull-right-lg indbtn2"><strong>Enquiry</strong></a>
                    @endif
                </div>
            </div>
                ...
                <div class="browser-mockup">
                    <div id="nav-tabContent" class="tab-content pb-3 lead pl-3 pr-3">
                        <div id="nav-first" role="tabpanel" aria-labelledby="nav-first-tab"
                            ...
                            <img src="{{asset('frontend/img/star.gif')}}" alt="..." width="250px" height="250px" class="img-fluid"
                ...
                <div class="browser-mockup">
                    <div class="tab-content pb-3 lead pl-3 pr-3">
                        <div role="tabpanel" aria-labelledby="nav-first-tab" class="tab-pane fade show active">
                            ...
                            <img src="{{asset('frontend/img/chip.gif')}}" alt="..." width="250px" height="250px" class="img-fluid"
                ...
                <div class="browser-mockup">
                    <div class="tab-content pb-3 lead pl-3 pr-3">
                        <div role="tabpanel" aria-labelledby="nav-first-tab" class="tab-pane fade show active">
                            ...
                            <img src="{{asset('frontend/img/hearts.gif')}}" alt="..." width="250px" height="250px" class="img-fluid"
        ...
        <header>
            <div class="row text-light text-center">
                <div class="col-md-7">
                    ...
                    <h4 class="pt-5 mx-auto text-white text-justify" data-aos="zoom-in-down"
                ...
                <div class="col-md-5">
                    <img src="{{asset('frontend/img/award.gif')}}" alt="" class="img-fluid" data-aos="fade-up-right"
                        data-aos-duration="3000">
                </div>
            </div>
        </header>
...
<section id="about-us" class="about-us mt-3 mb-5" data-aos="fade-down" data-aos-easing="linear"
    ...
    <div class="container text-center">
        <img src="{{asset('frontend/img/gears.gif')}}" alt="" class="img-circle" data-aos="fade-up-left" data-aos-duration="1000">
        <br><br>
