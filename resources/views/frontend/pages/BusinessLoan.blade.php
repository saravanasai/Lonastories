        ...
        <div class="row pt-5">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="pt-5 pb-5 text-lg-center text-sm-center ">
                    ...
                    <a href="{{route('signup.index')}}" class="btn btn-darkblue ml-lg-3 mr-lg-3 btn-sm"><strong>REFER</strong></a>
                    <a href="{{route('signup.index')}}" class="btn btn-darkblue btn-sm"><strong>SHARE</strong></a>
                    @else
                    <a href="{{route('quickEnquieryForm.index')}}" class="btn btn-success btn-sm"><strong>APPLY</strong></a>
                    <a href="{{route('home')}}" class="btn btn-darkblue ml-lg-3 mr-lg-3 btn-sm"><strong>REFER</strong></a>
                    <a href="{{route('quickEnquieryForm.store',session('customer')->id)}}" class="btn btn-darkblue btn-sm"><							strong>SHARE</strong></a>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="idROI" name="int_rate"  placeholder="Enter Your ROI" />
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="text-center text-sm-center">
                    <button type="button" class="btn btn-darkblue calc btn-sm">
                        <b>CALCULATE</b>
                    </button>
                    &nbsp;&nbsp;@if(!session('customer'))
                    <a href="{{route('signup.index')}}" class="btn btn-success btn-sm"><b>Apply Now</b></a>
                    @else
                    <a href="{{route('quickEnquieryForm.index')}}" class="btn btn-success btn-sm"><b>Apply Now</b></a>
                    @endif
                </div>
            </div>
        </div>
