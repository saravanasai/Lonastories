...
@section('content')
                    ...
                    <div class="pt-5 pb-5 text-center text-sm-center ">
                        ...
                        @else
                            ...
                            <a href="{{ route('home') }}#directRefsection"
                                class="btn btn-darkblue ml-lg-3 mr-lg-3 btn-sm"><strong>REFER</strong></a>
                            <a  data-toggle="modal" data-target="#shareNowBusinessLoan"
    ...
    <div class="modal fade" id="shareNowBusinessLoan" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
