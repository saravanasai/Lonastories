...
<img src="{{asset('frontend/img/about/banner 0.png')}}" alt="" class="img-fluid" data-aos="zoom-in" data-aos-duration="2000">
</div>
<section class="pt-0">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="{{asset('frontend/img/about/b1.png')}}" alt="" class="img-fluid" data-aos="zoom-in" data-aos-duration="2000">
        </div>
    </div>
</div>
</section>
...
<div class="container">
    <div class="row">
        <div class="col-md-6" data-aos="zoom-in" data-aos-duration="2000">
            <img src="{{asset('frontend/img/about/b3.jpg')}}" alt="" class="img-fluid">
        </div>
...
<div class="container pb-md-5" data-aos="fade-up-left" data-aos-duration="2000">
    <div class="row">
        <div class="col-md-6 pt-lg-5 text-center">
            ...
            <h4 class="pt-3 text-justify text-secondary font-weight-bold">We do all the math right, we
                understand
                your exact eligibility, we do a
                transparent discussion with both our Clients & Bankers. We take an opportunity only based on the
                scope of
                funding and so we maintain the best approval rate in the industry.</h4>
        </div>
        <div class="col-md-6 text-center"><img class="img-fluid" src="{{asset('frontend/img/about/b2.png')}}" alt=""
                data-aos="zoom-in-right" data-aos-duration="2000"></div>
    </div>
</div>
</section>

<section class="">
<h2 class="display-4 text-center" data-aos="fade-down" data-aos-duration="3000">We are the happiest, as we
...
<div class="container">
    <div class="row text-center">
        ...
        <div class="col-md-6 pt-5">
            ...
            <img src="{{asset('frontend/img/donate.png')}}" alt="" class="img-fluid col-4" data-aos="fade-up-left"
                data-aos-duration="2000">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-5 pl-5">
            <form action="{{route('directReferal.store')}}" method="POST">
                ...
                <div class="form-group pt-3" data-aos="fade-down" data-aos-easing="linear"
                    data-aos-duration="1500">
                    <label class="text-dark font-weight-bold" for="exampleInputPassword1">Mobile Number</label>
                    <input type="number" class="form-control" name="refer_to_cus_phonenumber" placeholder="Enter Your Number" required>
                </div>
                <div class="form-group pt-3" data-aos="fade-down" data-aos-easing="linear"
                    data-aos-duration="1500">
                    <label class="text-dark font-weight-bold" for="exampleInputPassword1">Email</label>
                    <input type="text" class="form-control" name="refer_to_cus_email" placeholder="Enter Email Address" onfocus="this.type='email'" onblur="this.type='text'" required>
                </div>
                <div class="form-group pt-3" data-aos="fade-down" data-aos-easing="linear"
                    data-aos-duration="2500">
                    <label class="text-dark font-weight-bold" for="exampleInputPassword1">Relationship</label>
                    <input type="text" class="form-control" name="refer_to_relationship" placeholder="Type of Relation" required>
                </div>
                <div class="text-center pt-3">
                    @if(session('customer'))
                    <p class="lead"><button type="submit" class="btn btn-block btn-darkblue"
                            ><strong>Submit</strong></a></button></p>
                    @else
                    <p class="lead"><a href="{{route('signup.index')}}" class="btn btn-block btn-darkblue"
                        ><strong>Submit</strong></a></a></p>
                    @endif
                </div>
            </form>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-sm-12 pt-5 pl-5 text-center pt-5" data-aos="fade-down"
            data-aos-duration="1500">
            ...
            @if(session('customer'))
            <h5 class="pt-5 pb-lg-3"><a href="{{route('quickEnquieryForm.edit',session('customer')->id)}}" class="btn btn-outline-dark mt-1"><strong>Share
            ...
            <h3><a href="#" target="_blank" title="Facebook" class="p-lg-4"><i class="fa fa-facebook"></i></a>
                ...
                <a href="#" target="_blank" title="whatsapp" class="p-lg-4"><i class="fa fa-whatsapp"></i></a>
            </h3>
            <br>
        </div>
