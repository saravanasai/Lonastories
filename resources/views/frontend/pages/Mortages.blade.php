            ...
            <div class="row justify-content-center pt-md-3">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    &nbsp;&nbsp;<input type="radio" id="commer" name="apr" placeholder=""
                                        required>
                                    <label for="">Commercial</label>
                                </div>
                                <div class="col-md-6">
                                    <h5><label for="">Property Value :</label></h5>
                                    <input type="number" id="propVal" name="apr" placeholder="Property Amount"
                ...
                <div class="col-md-4 pt-md-5 card ml-3">
                    <div class="form-group text-center pt-md-5">
                        ...
                        <button type="button" class="btn btn-success mortage">Calculate</button>
                    </div>
                </div>
            </div>
        </form>
