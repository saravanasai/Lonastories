...
@section('content')
                ...
                <div class="col-sm-7 order-sm-1 text-center" data-aos="fade-up-left" data-aos-duration="3000">
                    ...
                    @if (!session('customer'))
                        <a href="{{ route('signup.index') }}" class="btn btn-info" data-aos="fade-up"
                            data-aos-duration="2000"><b>QUICK
                                CONNECT</b></a>
                    @else
                        <a href="{{ route('quickEnquieryForm.index') }}" class="btn btn-info" data-aos="fade-up"
                            data-aos-duration="2000"><b>QUICK
                                CONNECT</b></a>
                    @endif
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" data-aos="fade-up-right" data-aos-duration="3000">
                    <img src="{{ asset('frontend/img/connect/h_loan.png')}}" alt="" class="img-fluid">
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 order-sm-12" data-aos="fade-up-left" data-aos-duration="3000">
                    <img src="{{ asset('frontend/img/connect/fast.png')}}" alt="" class="img-fluid">
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 pt-5 pl-5 ">
                    <img src="{{ asset('frontend/img/connect/roi.png')}}" alt="" class="img-fluid" data-aos="fade-up-left"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-sm-12">
                    <img src="{{ asset('frontend/img/connect/ccard.png')}}" alt="" class="img-fluid" data-aos="fade-up-right"
                        data-aos-duration="3000">
                </div>
    ...
    <section class="pt-lg-5 mt-lg-5">
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6 ">
                    <img src="{{ asset('frontend/img/connect/power.png')}}" alt="" class="img-fluid" data-aos="fade-up-right"
                        data-aos-duration="3000">
                </div>
                <div class="col-md-6 mt-4 text-center">
    ...
    <section class="pt-lg-5 mt-lg-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-sm-12">
                    <img src="{{ asset('frontend/img/connect/hbuisness.png')}}" alt="" class="img-fluid" data-aos="fade-up-left"
                        data-aos-duration="3000">
                </div>
    ...
    <section class="pt-lg-5 mt-lg-5">
        <div class="container">
            <div class="row mt-4">
                <div class="col-md-6 ">
                    <img src="{{ asset('frontend/img/connect/affordable.png')}}" alt="" class="img-fluid" data-aos="fade-up-right"
                        data-aos-duration="3000">
                </div>
                <div class="col-md-6 mt-4 text-center">
    ...
    <section class="pt-lg-5 mt-lg-5 ">
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-sm-12">
                    <img src="{{ asset('frontend/img/connect/kids.jpg')}}" alt="" class="img-fluid" data-aos="fade-up-left"
                        data-aos-duration="3000">
                </div>
