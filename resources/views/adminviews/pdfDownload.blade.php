...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script> --}}
    ...
    <div class="content ">
        <div class="container mt-1">
            ...
            @if(session('admin'))
            <div class="float-right"><p class="breadcrumb-item"><a href="{{route('admindashboard') }}">HOME</a></p></div>
            @endif
            @if(session('caller'))
        ...
        <div class="card card-purple">
            ...
            <div class="card-body">
              ...
              <div class="float-right">
                <a href="{{asset('storage/pdf/'.$pdf.'.pdf')}}" download="LoanStoriesFinalOffer" class="btn btn-success"><i class="fas fa-download px-1"></i>Download</a>
              </div>
              <div class="container mt-5 py-3">
                <iframe class="responsive-iframe" src="{{asset('storage/pdf/'.$pdf.'.pdf')}}" width="100%" height="600px"></iframe>
