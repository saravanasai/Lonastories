                    ...
                    @foreach ($new_user as $sno => $single_user)
                        <tr>
                            ...
                            <td>
                                ...
                                {{-- <div class="btn-group">
                                    <button type="button" id="{{ $single_user->qu_enq_id }}"
                                        class="btn btn-sm btn-success assign_to_admin"><i class="fas fa-user-shield px-2"></i>Admin</button>
                                    <button type="button" id="{{ $single_user->qu_enq_id }}"
                                        class="btn btn-sm btn-info assign_to_leader">
                                        <i class="fas fa-book-reader px-2"></i>Leader
                                    </button>
                                </div> --}}
                            </td>
                        </tr>
