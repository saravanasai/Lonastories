                        ...
                        <div class="card card-purple">
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item"><a class="nav-link text-white" href="#settings"
                                            data-toggle="tab">Assign To
                                        </a></li>
                                </ul>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                    ...
                                    <div class="tab-pane active" id="activity">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                                                <h3 class="text-gray"><i class="fas fa-info-circle"></i>Additional Info
                                                </h3>
                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        <a><i
                                                                class="fas fa-envelope pr-3"></i>{{ $more_info->email }}</a>
                                                    </li>
                                                ...
                                                <div class="text-center mt-5 mb-3">
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button" class="btn btn-success proceed"><i
                                                                class="fas fa-vote-yea px-1"></i>Proceed</button>
                                                ...
                                                @foreach ($leader_info as $single_leader)
                                                    <tr>
                                                        ...
                                                        <td><button type="button" id="{{ $single_leader->id }}"
                                                                class="btn btn-sm btn-primary assign"><i
                                                                    class="fas fa-clipboard-check px-1"></i>Assign</button>
