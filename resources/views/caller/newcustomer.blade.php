...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-1">
                <div class="col-sm-6">
                    <h4 class="m-0">ADD NEW CUSTOMER LEADER VIEW</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="PhoneNumber" name="Phone Number"  placeholder="Enter Phone Number">
                                </div>
                            </div>
                            <div class="col col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class=" col col-md-2">
                                <div class="form-group">
                                    <label for="total_salary">Net Monthly Income</label>
                                    <input type="number" class="form-control" id="total_salary" name="total_salary" placeholder="Net Monthly Income">
                                </div>
                            </div>
                            <div class=" col col-md-3">
                                <div class="form-group">
                            ...
                            <div class=" col col-md-2">
                                <div class="form-group">
                                    <label for="no_of_credit_card">No of Credit Cards</label>
                        ...
                        <div class="row">
                            <div class="col col-md-3">
                                <div class="form-group">
                                    <label for="credit_card_outstanding">Credit Cards Outstanding</label>
                                    <input type="number" class="form-control" id="credit_card_outstanding" name="credit_card_outstanding" placeholder="Cards outstanding amount">
                                </div>
                            </div>
                            <div class=" col col-md-3">
                                <div class="form-group">
                                    <label for="credit_card_obligation">Credit Cards Obligation</label>
    ...
    $(function() {
                         ...
                         if(validation_status)
                          {
                             ...
                             let final_obligation=Math.round(Number(total_obligation)+Number(credit_card_obligation));
        ...
        $(".btnleadgen").click(function(event) {
            ...
            var id=$("#id").val();
                     ...
                     var url = '{{ route('caller.StoreNewCustomer', ':id') }}';
                     ...
                     if(validation_status_to_submit)
                     {
                        $.ajax({
                                ...
                                success: function(data) {
                                      ...
                                      {
                                        Swal.fire({
                                            title: 'Refferal Link Has Been Sent Successfully',
