...
@section('content')
    ...
    <div class="content">
        <div class="container mt-2">
            <h4 class="mb-4">Upload Mandatory Files LEADER VIEW</h4>
            @if (session('admin'))
            ...
            @if (session('caller'))
                <div class="float-right">
                    <p class="breadcrumb-item"><a href="{{ route('offerAcceptedFileUploadLeader.index', session('caller')->id) }}">Back</a></p>
                </div>
            @endif
        </div>
            ...
            <div class="card card-purple mt-5">
                ...
                @if($man_doc_status==1)
                    <div class="container p-5">
                        <center>
                            <h5>FILE UPLOADED</h5>
                            <a href="{{route('offerAcceptedFileUploadLeader.index')}}" class="btn btn-success "> <i class="fas fa-backward px-2"></i>Go Back</a>
                        </center>
                    </div>
                @else
                    <!-- form start -->
                ...
                <div class="container p-5">
                    <center>
                        <h5>FILE UPLOADED</h5>
                        <a href="{{route('offerAcceptedFileUploadLeader.index')}}" class="btn btn-success ">Upload Other Documents</a>
                    </center>
                </div>
                @else
