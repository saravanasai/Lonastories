            ...
            <div class="col-12 col-sm-6 col-md-12 d-flex align-items-stretch flex-column">
                <div class="card bg-light d-flex flex-fill">
                        ...
                        <div class="row">
                            <div class="col-3">
                                ...
                                <ul class="ml-4 mb-0 fa-ul text-muted">
                                    <li class="small p-1"><span class="fa-li "><i
                                                class="fas fa-lg fa-building"></i></span> Loaction:
                                        {{ $customer_info->current_loation }}</li>
                                    <li class="small p-1"><span class="fa-li "><i
                                                class="fas fa-lg fa-phone"></i></span> Phone :
                                        {{ $customer_info->enquiery_cus_ph }} </li>
                                </ul>
                            </div>
                            <div class="col-2 text-center">
                                <img src="https://image.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg"
                                    alt="user-avatar" class="img-circle img-fluid" width="100px" height="100px">
                            </div>
                            <div class="col-7">
                                {{-- form first row --}}
                                <div class="row">
                                    <div class="col col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Con_lead_bussiness_name"
                                                value="{{ $customer_info->current_loation }}" name="Con_lead_bussiness_name"
                                                placeholder="" disabled>
                                            <input type="hidden" class="form-control" id="cus_id" name="cus_id"
                                                value="{{ $customer_info->cus_id }}">
                                            <input type="hidden" class="form-control" id="enq_id" name="enq_id"
                                                value="{{ $customer_info->enq_id }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="con_lead_lg_name">LG NAME</label>
                                            <input type="text" class="form-control" id="con_lead_lg_name"
                                                name="con_lead_lg_name"
                                                value="{{ $converted_feilds_info->con_lead_lg_name }}" placeholder=""
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="con_lead_lc_name"
                                                name="con_lead_lc_name"
                                                value="{{ $converted_feilds_info->con_lead_lc_name }}"
                                                placeholder="LC Name" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="con_lead_source_team"
                                                name="con_lead_source_team"
                                                value="{{ $converted_feilds_info->con_lead_source_team }}"
                                                placeholder="Source Team" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="">CHANNEL</label>
                                            <select class="form-control" id="con_lead_channel" name="con_lead_channel"
                                                disabled>
                                                <option value="{{ $converted_feilds_info->con_lead_source_team }}"
                                                    selected>{{ $converted_feilds_info->con_lead_source_team }}</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="con_lead_bank_name"
                                                name="con_lead_bank_name"
                                                value="{{ $converted_feilds_info->con_lead_bank_name }}"
                        ...
                        <div class="row">
                            <div class="col col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="con_lead_vendor_name"
                                        name="con_lead_vendor_name"
                                        value="{{ $converted_feilds_info->con_lead_vendor_name }}"
                                        placeholder="vendor_name" disabled>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="con_lead_loan_amount_applied"
                                        name="con_lead_loan_amount_applied"
                                        value="{{ $converted_feilds_info->con_lead_loan_amount_applied }}"
                                        placeholder="Loan Amount Applied" disabled>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="con_lead_product_name">PRODUCT NAME</label>
                                    <input type="text" class="form-control" id="con_lead_product_name"
                                        value="{{ $customer_info->productname }}" name="con_lead_product_name"
                            ...
                            <div class="col col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="con_lead_sub_product_name"
                                        value="{{ $customer_info->subproductname }}" name="con_lead_sub_product_name"
                                        placeholder="Sub Product Namesub_" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Enter ..." id="con_lead_remarks"
                                        name="con_lead_remarks">{{ $converted_feilds_info->con_lead_remarks }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="btn btn-success" id="last_status"
                                        value="{{ $converted_feilds_info->status_code }}" name="last_status" disabled>
                                </div>
                            </div>
                            <div class="col col-md-3">
                                <div class="form-group">
                                    <label for="con_lead_login_ref_no">LOGIN REF NO</label>
                                    <input type="text" class="form-control" id="con_lead_login_ref_no"
                                        value="{{ $converted_feilds_info->con_lead_login_ref_no }}"
                                        name="con_lead_login_ref_no" placeholder="Login Ref No" disabled>
                                </div>
                            </div>
                        </div>
                        {{-- section displayed only if the status slection is disbrusement --}}
                        <div id="disbrusement_section">
                            <div id="disbrusement_alert" class="text-danger"><Strong>ALL HIGHLIGHTED FEILDS SHOULD BE
                                    FILLED AND SHOULD BE IN NUMERIC </Strong></div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="con_lead_loan_amount_aproved">LOAN AMOUNT APPROVED</label>
                                        <input type="number" class="form-control" id="con_lead_loan_amount_aproved"
                                            name="con_lead_loan_amount_aproved" placeholder="Loan Amount Approved">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="con_lead_roi">ROI</label>
                                        <input type="number" class="form-control" id="con_lead_roi" name="con_lead_roi"
                                            placeholder="Roi">
                                    </div>
                                </div>
                                <div class="col col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="con_lead_tennure"
                                            name="con_lead_tennure" placeholder="Tennure">
                                    </div>
                                </div>
                                <div class="col col-md-3">
                                    <div class="form-group">
                                        <label for="con_lead_emi">EMI</label>
                                        <input type="text" class="form-control" id="con_lead_emi" name="con_lead_emi"
                            ...
                            <div class="row">
                                <div class="col col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="con_lead_insurance_status"
                                            name="con_lead_insurance_status">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="con_lead_pf_gst"
                                            name="con_lead_pf_gst" placeholder="PF Gst">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="con_lead_stamp_duty">STAMP DUTY</label>
                                        <input type="number" class="form-control" id="con_lead_stamp_duty"
                                            name="con_lead_stamp_duty" placeholder="Stamp Duty">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="con_lead_gap_inter_emi"
                                            name="con_lead_gap_inter_emi" placeholder="Gap Interest Emi">
                                    </div>
                                </div>
                                <div class="col col-md-3">
                                    <div class="form-group">
                                        <label for="con_lead_insurance_premium">INSURANCE PREMIUM</label>
                                        <input type="number" class="form-control" id="con_lead_insurance_premium"
                                            name="con_lead_insurance_premium" placeholder="Insurance Premium">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="con_lead_other_charges">OTHER CHARGES</label>
                                        <input type="number" class="form-control" id="con_lead_other_charges"
                                            name="con_lead_other_charges" value="0" placeholder="Other Charges">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group p-4">
                                        <button type="button" class="btn btn-info" id="con_lead_cal_btn"> <i
                                                class="fas fa-calculator px-1"></i>Calculate</button>
                                        <button type="button" class="btn btn-danger" id="con_lead_edit_btn"><i
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        <div class="text-left">
                            <a href="{{ asset('userDocuments/' . $pancard) }}" download="Pancard"
                                class="btn btn-sm btn-primary px-1">
                                <i class="fas fa-download px-1"></i>PAN CARD
                            </a>
                            <a href="{{ asset('userDocuments/' . $adharcard) }}" download="Adharcard"
                                class="btn btn-sm btn-primary px-1" download>
                                <i class="fas fa-download px-1"></i>ADHAR CARD
                            </a>
                            <a href="{{ asset('enquieryDoc/' . $enq) }}" download="Enquiery Document"
                                class="btn btn-sm btn-primary px-1">
                                <i class="fas fa-download px-1"></i>ENQUIERY DOCUMENTS
                            </a>
                            <a href="{{ asset('storage/pdf/' . $offerpdf . '.pdf') }}" download="LoanStoriesOffer"
                                class="btn btn-sm btn-primary px-1">
                                <i class="fas fa-download px-1"></i>OFFER PDF
                            </a>
                        </div>
                        <div class="text-right px-3">
                            <button type="submit" id="con_lead_update_btn" class="btn btn-success float-right"><i
                                    class="fas fa-paper-plane px-1"></i>Update</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $('body').on('click', '#con_lead_update_btn', function() {
            ...
            if (update_status == 16) {
                ...
                if (lead_loan_amount_applied == "" || !$.isNumeric(lead_loan_amount_applied)) {
                    ...
                    $('#con_lead_loan_amount_applied_error').html(
                        'Amount Should Be in Numeric and Not Empty');
                    validation_status_re_login = false;
                }
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href =
                                            "{{ route('feildForConCaseLeader.index') }}";
