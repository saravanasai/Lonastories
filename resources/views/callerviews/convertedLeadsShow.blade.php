                ...
                <div class="card bg-light d-flex flex-fill">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="con_lead_lg_name"
                                                name="con_lead_lg_name" value="{{ $reffered_by }}" placeholder=""
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="con_lead_lc_name"
                                                name="con_lead_lc_name" value="{{ old('con_lead_lc_name') }}"
                                    ...
                                    <div class="col col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="con_lead_source_team"
                                                name="con_lead_source_team" value="{{ old('con_lead_source_team') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="con_lead_bank_name"
                                                name="con_lead_bank_name" value="{{ old('con_lead_bank_name') }}"
                            ...
                            <div class="col col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="con_lead_vendor_name"
                                        name="con_lead_vendor_name" placeholder="Vevendor_name" disabled>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="con_lead_loan_amount_applied"
                                        ...
                                        value="{{ old('con_lead_loan_amount_applied') }}" placeholder="Loan Amount Applied"
                                        disabled>
                                </div>
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        ...
                        <div class="text-right px-3">
                            <button type="button" id="before_info_btn_submit" class="btn btn-success float-right"><i
                                    class="fas fa-paper-plane px-1"></i>SUBMIT</button>
                        </div>
                    </div>
                </div>
            </div>
