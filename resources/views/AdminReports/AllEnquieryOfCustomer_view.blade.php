                ...
                <div class="col mt-1">
                    @if (session('admin'))
                        <div class="float-right">
                            <p class="breadcrumb-item"><a href="{{ route('allEnquieryofCustomer.index') }}">Back</a></p>
                        </div>
                    @endif
                    @if (session('caller'))
                        <div class="float-right">
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Converted Enquiery Reports</h3>
              <div class="card-tools">
                    <form action="{{route('ConvertedEnquieryReports.export')}}" method="post">
                        @csrf
            ...
            <div class="card-body table-responsive p-0">
                @include('components.all-enquiery-of-customer-table',$user_info)
            </div>
            <!-- /.card-body -->
