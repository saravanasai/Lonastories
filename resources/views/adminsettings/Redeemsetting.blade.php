...
@section('content')
    ...
    <div class="content">
        <div class="container mt-1">
            <div class="row">
                <div class="col">
                    <h5 class="mb-4 mt-5">REDEMPTION</h5>
                </div>
                <div class="col mt-1">
                    @if (session('admin'))
                ...
                <div class="row">
                   <div class="col col-md-6 offset-md-2">
                    <div class="callout callout-warning">
                        ...
                        This Setting is to Enable a Redeem option for all Users
                    </div>
                   </div>
                </div>
                <div class="row">
                    <div class="col col-md-8 offset-md-4">
                        @if (session('success'))
                        <div class="toast bg-gray fade show" role="alert" aria-live="assertive"
                            aria-atomic="true">
                            <div class="toast-header"><strong class="mr-auto">Success</strong>
                                   </div>
                            <div class="toast-body text-center">{{session('success')}}
                                <a class="btn btn-success" href="{{ route('admindashboard') }}">Home</a>
                            </div>
                        </div>
                    @else
                        <form action="{{ route('redeemsetting.master') }}" method="post">
                            @csrf
                            <input type="hidden" name="enable" value="1">
                            <button type="submit" class="btn btn-danger">Enable Reedem</button>
                        </form>
                    @endif
                    </div>
                </div>
